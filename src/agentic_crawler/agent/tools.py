...
def get_action_registry() -> dict[str, Action]:
    """Return a mapping of action name -> Action instance."""
    actions: list[Action] = [
        NavigateAction(),
        ClickAction(),
        FillFormAction(),
...
def get_tool_schemas() -> list[dict[str, Any]]:
    """Return tool schemas in the generic format (converted per-provider later)."""
    return [
        {
            "name": "navigate",
        ...
        },
        {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "form_selector": {"type": "string", "description": "CSS selector of the form", "default": "form"},
                },
                "required": ["fields"],
            },
        },
        ...
        },
        {
            ...
            "parameters": {
                "type": "object",
                "properties": {
                    "instruction": {"type": "string", "description": "Description of what data is being extracted"},
                    "data": {"description": "The extracted data (any JSON-serializable structure)"},
                },
        ...
        },
        {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "seconds": {"type": "number", "description": "Seconds to wait (if no selector)", "default": 2},
                },
            },
        },
        {
