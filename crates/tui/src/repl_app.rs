...
fn handle_slash_command_tui(
    ...
    match cmd {
        ...
        SlashCommand::Memory {
            ...
            let report = crate::app::memory_build_evidence_report(
                &runtime::EpisodeStore::default_for_config_home(),
                &runtime::EvidenceStore::default_for_config_home(),
            );
            state.push_system_card("Memory", &report);
        ...
        SlashCommand::Memory {
            ...
            let report = crate::app::memory_evidence_report(
                &runtime::EvidenceStore::default_for_config_home(),
            );
            state.push_system_card("Memory", &report);
        }
        ...
        SlashCommand::Memory {
            ...
            let report = crate::app::memory_skill_plan_report(
                &runtime::EvidenceStore::default_for_config_home(),
            );
            state.push_system_card("Memory", &report);
        }
        SlashCommand::Memory {
            ...
            let report = crate::app::memory_workflow_report(
                &runtime::EpisodeStore::default_for_config_home(),
                &runtime::EvidenceStore::default_for_config_home(),
            );
            state.push_system_card("Memory", &report);
